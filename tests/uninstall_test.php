...
/**
 * Tests for the mod_playervideo pre-uninstallation hook.
 *
...
/**
 * Tests for xmldb_playervideo_uninstall(). Every table in db/install.xml is dropped
 ...
 * xmldb_mod_playervideo_uninstall() form fails this test with "Call to undefined
 * function" instead of silently never running in production.
 *
 * @covers ::xmldb_playervideo_uninstall
 */
final class uninstall_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        parent::setUp();
        $this->resetAfterTest();
        require_once($CFG->dirroot . '/mod/playervideo/db/uninstall.php');
    }

    /**
     * Tests that the uninstall hook deletes only mod_playervideo-prefixed preferences,
    ...
    public function test_uninstall_with_no_matching_preferences_is_a_noop(): void {
        $this->assertTrue(xmldb_playervideo_uninstall());
    }
}
