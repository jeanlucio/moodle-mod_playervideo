...
$functions = [
    ...
    'mod_playervideo_get_pending_corrections' => [
        'classname' => 'mod_playervideo\external\get_pending_corrections',
        'methodname' => 'execute',
        'description' => 'Lists open-question responses awaiting correction.',
        'type' => 'read',
        'ajax' => true,
        'capabilities' => 'mod/playervideo:reviewresponses',
    ],
    'mod_playervideo_generate_response_correction' => [
        'classname' => 'mod_playervideo\external\generate_response_correction',
        'methodname' => 'execute',
        'description' => 'Generates an AI grading suggestion for an open-question response.',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'mod/playervideo:reviewresponses',
    ],
    'mod_playervideo_review_response' => [
        'classname' => 'mod_playervideo\external\review_response',
        'methodname' => 'execute',
        'description' => 'Confirms the final grade of an open-question response.',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'mod/playervideo:reviewresponses',
    ],
    'mod_playervideo_get_report' => [
        'classname' => 'mod_playervideo\external\get_report',
        'methodname' => 'execute',
        'description' => 'Builds the per-question and per-student analytics report.',
        'type' => 'read',
        'ajax' => true,
        'capabilities' => 'mod/playervideo:viewreports',
    ],
];
