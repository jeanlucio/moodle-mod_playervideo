...
$string['aianswercount'] = 'Number of answer options';
...
$string['privacy:metadata:vimeo'] = 'Video hosted on Vimeo is embedded in this activity. When a student opens it, their browser connects to Vimeo directly to load the player and the video.';
$string['privacy:metadata:vimeo:useragent'] = 'The student\'s browser user agent, sent to Vimeo when the browser requests the embedded player.';
$string['privacy:metadata:vimeo:userip'] = 'The student\'s IP address, sent to Vimeo when the browser requests the embedded player.';
$string['privacy:metadata:vimeo:videoid'] = 'The identifier of the Vimeo video the teacher chose, sent to Vimeo to load it.';
$string['privacy:metadata:youtube'] = 'Video hosted on YouTube is embedded in this activity. When a student opens it, their browser connects to YouTube directly to load the player and the video.';
$string['privacy:metadata:youtube:useragent'] = 'The student\'s browser user agent, sent to YouTube when the browser requests the embedded player.';
$string['privacy:metadata:youtube:userip'] = 'The student\'s IP address, sent to YouTube when the browser requests the embedded player.';
$string['privacy:metadata:youtube:videoid'] = 'The identifier of the YouTube video the teacher chose, sent to YouTube to load it.';
...
$string['resumeattempt'] = 'Resume attempt';
...
$string['usetranscriptascaption'] = 'Save as caption';
